...
@section('content')
    <div class="landing-page" style="background-color: #f8f9fa;">
        <section class="hero text-center py-5 bg-light">
            <div class="container">
                ...
                <a href="{{ url('/lokawi') }}" class="btn btn-primary btn-lg explore-btn">Jelajahi Sekarang</a>
                <style>
                    .explore-btn {
    ...
    <section class="popular-landmarks py-5 bg-white">
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <img src="{{ asset('images/monas-2.jpg') }}" class="card-img-top" alt="Monas (Monumen Nasional)">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <img src="{{ asset('images/borobudur.jpg') }}" class="card-img-top" alt="Candi Borobudur">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <img src="{{ asset('images/kuta.jpg') }}" class="card-img-top" alt="Pantai Kuta">
                        <div class="card-body">
        ...
        <div class="container mt-5">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm">
                <img src="{{ asset('images/derawan.jpg') }}" class="card-img-top" alt="Kepulauan Derawan">
                <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm">
                <img src="{{ asset('images/waerebo.jpg') }}" class="card-img-top" alt="Desa Wae Rebo">
                <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm">
                <img src="{{ asset('images/nusa-penida.jpg') }}" class="card-img-top" alt="Nusa Penida">
                <div class="card-body">
