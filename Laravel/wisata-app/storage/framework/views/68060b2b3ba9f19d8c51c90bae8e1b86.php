...
<div class="container mb-5">
    ...
    <div class="d-flex overflow-auto">
        <div class="card me-3" style="min-width: 250px; max-width: 250px;">
            <img src="<?php echo e(asset('images/kuta.jpg')); ?>" class="card-img-top" alt="Pantai Kuta" style="height: 150px; object-fit: cover;">
            <div class="card-body">
        ...
        <div class="card me-3" style="min-width: 250px; max-width: 250px;">
            <img src="<?php echo e(asset('images/borobudur.jpg')); ?>" class="card-img-top" alt="Candi Borobudur" style="height: 150px; object-fit: cover;">
            <div class="card-body">
        ...
        <div class="card me-3" style="min-width: 250px; max-width: 250px;">
            <img src="<?php echo e(asset('images/monas.jpg')); ?>" class="card-img-top" alt="Monas" style="height: 150px; object-fit: cover;">
            <div class="card-body">
        ...
        <div class="card me-3" style="min-width: 250px; max-width: 250px;">
            <img src="<?php echo e(asset('images/bromo.jpg')); ?>" class="card-img-top" alt="Gunung Bromo" style="height: 150px; object-fit: cover;">
            <div class="card-body">
        ...
        <div class="card me-3" style="min-width: 250px; max-width: 250px;">
            <img src="<?php echo e(asset('images/toba.jpg')); ?>" class="card-img-top" alt="Danau Toba" style="height: 150px; object-fit: cover;">
            <div class="card-body">
        ...
        <div class="card me-3" style="min-width: 250px; max-width: 250px;">
            <img src="<?php echo e(asset('images/ampat.jpg')); ?>" class="card-img-top" alt="Raja Ampat" style="height: 150px; object-fit: cover;">
            <div class="card-body">
        ...
        <div class="card me-3" style="min-width: 250px; max-width: 250px;">
            <img src="<?php echo e(asset('images/tmii.jpg')); ?>" class="card-img-top" alt="Taman Mini Indonesia Indah" style="height: 150px; object-fit: cover;">
            <div class="card-body">
...
<div class="container mb-5">
    ...
    <div class="d-flex overflow-auto">
        <div class="card me-3" style="min-width: 250px; max-width: 250px;">
            <img src="<?php echo e(asset('images/derawan.jpg')); ?>" class="card-img-top" alt="Kepulauan Derawan" style="height: 150px; object-fit: cover;">
            <div class="card-body">
        ...
        <div class="card me-3" style="min-width: 250px; max-width: 250px;">
            <img src="<?php echo e(asset('images/waerebo.jpg')); ?>" class="card-img-top" alt="Desa Wae Rebo" style="height: 150px; object-fit: cover;">
            <div class="card-body">
        ...
        <div class="card me-3" style="min-width: 250px; max-width: 250px;">
            <img src="<?php echo e(asset('images/harau.jpeg')); ?>" class="card-img-top" alt="Lembah Harau" style="height: 150px; object-fit: cover;">
            <div class="card-body">
        ...
        <div class="card me-3" style="min-width: 250px; max-width: 250px;">
            <img src="<?php echo e(asset('images/sempu.jpg')); ?>" class="card-img-top" alt="Pulau Sempu" style="height: 150px; object-fit: cover;">
            <div class="card-body">
        ...
        <div class="card me-3" style="min-width: 250px; max-width: 250px;">
            <img src="<?php echo e(asset('images/jumog.jpg')); ?>" class="card-img-top" alt="Air Terjun Jumog" style="height: 150px; object-fit: cover;">
            <div class="card-body">
...
<?php echo $__env->make('template.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wisata-app\resources\views/lokawi.blade.php ENDPATH**/ ?>